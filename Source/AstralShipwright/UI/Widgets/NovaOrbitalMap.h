...
struct FNovaOrbitalObject
{
	...
	const FSlateBrush* GetBrush() const
	{
		if (Maneuver.IsValid())
		{
			return FNeutronStyleSet::GetBrush("Map/SB_Maneuver");
		}
		else if (Area.IsValid())
		{
			return FNeutronStyleSet::GetBrush("Map/SB_Area");
		}
		else if (AsteroidIdentifier.IsValid())
		{
			return FNeutronStyleSet::GetBrush("Map/SB_Asteroid");
		}
		else
		{
			return FNeutronStyleSet::GetBrush("Map/SB_Spacecraft");
		}
	}
